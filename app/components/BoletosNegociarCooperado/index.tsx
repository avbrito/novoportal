...
const BoletosNegociarCooperado = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white dark:bg-verde-dark dark:text-white">
      ...
      {selectedBoletos.length === 0 ? (
        ...
        <Link
          href={`/Cooperado/FinanceiroDemonstrativos/Pagamentos/Negociar/${metodoPagamento === "pix" ? "PIX" : "Credito"}`}
...
export default BoletosNegociarCooperado;
