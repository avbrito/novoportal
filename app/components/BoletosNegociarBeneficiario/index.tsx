  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white dark:bg-verde-dark dark:text-white">
      ...
      <div className="space-x-4 items-center pt-4 pb-4">
        ...
        <hr />
        <div className="mr-10 pt-8 table-cell">
          <p className="text-black pb-8">Selecione o método de pagamento</p>
          <div className="flex flex-col space-y-2 text-black">
            ...
            <label className="flex items-center space-x-2 pt-4 pb-10">
              <input
                type="radio"
                name="metodoPagamento"
                value="pix"
      ...
      {selectedBoletos.length === 0 ? (
        ...
        <Link
          href={`/Beneficiario/Financeiro/QuitacaoAnualDividas/Negociar/${metodoPagamento === "pix" ? "PIX" : "Credito"}`}
