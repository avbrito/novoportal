...
const SegundaViaCartao = () => {
  ...
  const subtitleText = "Existe uma taxa de R$ 15,00 para emissão de uma nova carteirinha, que poderá ser isenta em caso de roubo com a apresentação de um boletim de ocorrência";
      ...
      <Layout>
        ...
        {isClient && (
          <SegViaCartao
            ...
            onButtonClick={() => router.push("/Empresa/SegundaViaCartao/NovoCartaoBenef")}
          />
        )}
      </Layout>
    </MenuProvider>
