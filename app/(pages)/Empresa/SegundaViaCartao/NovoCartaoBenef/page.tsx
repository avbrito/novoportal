      ...
      <Layout>
        <div className="min-h-screen bg-white dark:bg-verde-dark px-4 sm:px-6 py-6">
          <div className="w-full max-w-[808px] mx-auto">
            ...
            <p className="text-blue-black font-sans text-lg dark:text-white mb-8">
            ...
            <div
              ...
              onClick={() =>
                router.push("/Empresa/SegundaViaCartao/NovoCartaoBenef/DadosPessoais")
              }
            >
                ...
                >
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-xs flex items-center">
                      <span className="mr-2 text-blue-black dark:text-gray-400">
                        <CarteirinhaIcon />
                      </span>
                      {b.numero}
                    </p>
