...
import Logo from "../../../public/assets/imgs/logo-unimed.png";
...
export default function Login() {
  ...
  const handleOptionClick = (userType: string, href: string, icon: any) => {
          ...
          <div className="my-6 space-y-4">
            {OPTIONS.map((option) => (
              <button
                ...
                onClick={() => handleOptionClick(option.userType, option.redirect.href, option.icon)}
              >
