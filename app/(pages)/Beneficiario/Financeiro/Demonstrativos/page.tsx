...
import { demonstrativos } from "@/app/utils/const";
      ...
      <Layout>
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="space-y-4">
            {demonstrativos.map((item, index) => (
              <div
                key={index}
                className="p-6 border rounded-lg border-blue-lightest hover:shadow-md transition flex justify-between items-center cursor-pointer gap-5"
                onClick={() => router.push(item.redirect.href)} 
              >
                <div>
                  <h2 className="text-lg font-sans text-blue-black dark:text-gray-200">{item.title}</h2>
