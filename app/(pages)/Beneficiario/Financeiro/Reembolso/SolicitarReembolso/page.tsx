        ...
        <div className="min-h-screen bg-white dark:bg-verde-dark p-6 flex ml-5 items-start">
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-600 dark:text-white text-sm mb-4">
              Para quem será o reembolso?
            </p>
            <div className="w-80 space-y-3" onClick={() => router.push("/Beneficiario/Financeiro/Reembolso/SolicitarReembolso/SolicitarReembolsoTipo")}>
