...
export default function Motivo() {
  ...
  return (
    <MenuProvider>
      <Layout>
        <div className="min-h-screen bg-white dark:bg-verde-dark p-6">
          <div className="max-w-[808px] mx-auto">
            ...
            <div
              ...
              onClick={() =>
                router.push(
                  "/Empresa/SegundaViaCartao/NovoCartaoBenef/DadosPessoais/Endereco/Motivo/MotivoSolicitacao"
                )
              }
            >
              {beneficiarios.map((b, index) => (
                <div
                  key={index}
                  className="p-4 border rounded-lg flex justify-between items-center mt-4 cursor-pointer bg-gray-card hover:bg-gray-100"
                >
