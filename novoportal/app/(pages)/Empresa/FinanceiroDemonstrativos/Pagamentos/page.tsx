      ...
      <Layout>
        <div className="bg-white dark:bg-verde-dark p-4">
          <div className="flex flex-col bg-white dark:bg-verde-dark justify-center items-center">
            <div className="w-full max-w-[680px] pt-2">
              ...
              <div className="border text-red-erro border-red-erro rounded-lg p-4 -mt-5 mb-5 flex justify-between items-center">
                ...
                <Link href="/Beneficiario/Financeiro/Pagamentos/Negociar">
                    ...
                    {categoria.items.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="flex space-x-4">
                          <Link href="/Empresa/FinanceiroDemonstrativos/Pagamentos/PIX">
                            <button className="text-blue-500 font-sans text-sm hover:underline">
                              <Pix />
                              PIX
                            </button>
                          </Link>
                          <Link href="/Empresa/FinanceiroDemonstrativos/Pagamentos/Boleto">
                            <button className="text-blue-500 font-sans text-sm hover:underline">
                              <CopiarPix />
                              Boleto
                            </button>
                          ...
                          <a
                            href="https://link.testfile.org/PDF10MB"
                            target="_blank"
                          >
                            <button className="text-blue-500 font-sans text-sm hover:underline">
                              <SegundaViaPix />
