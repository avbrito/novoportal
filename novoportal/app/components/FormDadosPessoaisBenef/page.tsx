...
export default function FormDadosPessoaisBenef() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      router.push(
        "/Beneficiario/SegundaViaCartao/NovoCartaoBenef/DadosPessoais/Endereco"
      );
    }
  };
    ...
    <form onSubmit={handleSubmit} className="w-80 space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className={`mt-1 w-full rounded-md border px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${
